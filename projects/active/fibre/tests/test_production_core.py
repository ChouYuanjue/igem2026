...
from projects.active.fibre.core.engine import payload_to_argv
from projects.active.fibre.core.evidence import (
...
from projects.active.fibre.runtime import cli as rank_open_world
from projects.active.fibre.runtime.cli import build_parser, candidate_subset_indices
...
def test_current_r2e_uses_route_specific_bundle_without_invalidating_external_bundle():
    ...
    assert current.route_version == "bime-rank-production-routes-v2"
...
def test_candidate_universe_versions_follow_actual_assets():
    from projects.active.fibre.core.candidate_universes import resolve_candidate_universe
