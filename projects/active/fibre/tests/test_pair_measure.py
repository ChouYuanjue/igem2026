...
from projects.active.fibre.geometry.pair_measure import (
...
def test_product_pushforward_preserves_mass_and_has_no_axis_order():
    from scipy.sparse import csr_matrix
    from projects.active.fibre.geometry.pair_measure import anisotropic_product_pushforward
...
def test_symmetrized_product_pushforward_is_mass_conserving_and_axis_equivariant():
    from scipy.sparse import csr_matrix
    from projects.active.fibre.geometry.pair_measure import symmetrized_anisotropic_product_pushforward
...
def test_second_order_product_pushforward_is_mass_conserving_and_axis_equivariant():
    from scipy.sparse import csr_matrix
    from projects.active.fibre.geometry.pair_measure import second_order_anisotropic_product_pushforward
...
def test_product_heat_pushforward_is_mass_conserving_and_axis_equivariant():
    from scipy.sparse import csr_matrix
    from projects.active.fibre.geometry.pair_measure import anisotropic_product_heat_pushforward
...
def test_factor_sum_heat_is_mass_conserving_and_axis_equivariant():
    from scipy.sparse import csr_matrix
    from projects.active.fibre.geometry.pair_measure import anisotropic_factor_sum_heat_pushforward
