...
from projects.active.fibre.geometry.multiscale import _self_tuning_scale
...
def main() -> None:
    ...
    manifest = {
        ...
        'purpose': 'self-contained read-only MARTS reference atlas for exact FIBRE correspondence-field query extension',
