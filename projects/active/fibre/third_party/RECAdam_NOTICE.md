...
The optimizer source is kept as upstream code. project-specific scheduling and parameter matching live in `train_general_evidence_retriever.py` rather than modifying the vendored optimizer.
