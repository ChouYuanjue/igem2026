...
CACHE=ROOT/'data/terpene_marts_adaptation'; PG=ROOT/'data/terpene_multiresolution_protein_geometry_v4'; RG=ROOT/'data/terpene_multiresolution_reaction_geometry_v2'; HG=ROOT/'data/terpene_hierarchical_factor_geometry_v2'; OUT=ROOT/'results/terpene_product_geodesic_dev_v4'; BUD=(3,10,20)
def sha(p):
 h=hashlib.sha256()
 with open(p,'rb') as f:
