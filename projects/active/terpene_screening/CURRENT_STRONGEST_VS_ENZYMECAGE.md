...
A genuinely fresh source-snapshot external protocol has therefore been frozen before reveal: Rhea release 128 (2023-07-12, matching the clean2023 source boundary) -> release 141 (2026-06-10), using performance-blind Swiss-Prot association deltas and the unchanged 185,918-protein candidate support. The protocol requires at least 50 eligible reaction queries and 200 test pairs; otherwise it is reported as underpowered rather than relaxed. No Rhea128->141 model performance may be used to modify the residual or benchmark definition.
