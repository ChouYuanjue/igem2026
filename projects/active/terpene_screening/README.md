...
`not_applicable_current_entity`; few-shot, masked and manual-override routes do
not inherit the default external guarantee. Applicability-aware Mondrian groups
