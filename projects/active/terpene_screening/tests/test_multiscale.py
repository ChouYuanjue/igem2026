...
def test_self_tuning_product_neighbours_balances_view_scales():
    from projects.active.terpene_screening.geometry.multiscale import self_tuning_product_neighbours
...
def test_information_product_neighbours_prefers_sharp_coordinate():
    from projects.active.terpene_screening.geometry.multiscale import information_product_neighbours
...
def test_information_product_affinity_is_symmetric_and_finite():
    from projects.active.terpene_screening.geometry.multiscale import information_product_affinity
...
def test_perplexity_contraction_grows_with_resolution():
    from projects.active.terpene_screening.geometry.multiscale import _perplexity_contraction_from_energy
...
def test_resolution_product_neighbours_preserves_sharp_fine_view():
    from projects.active.terpene_screening.geometry.multiscale import resolution_product_neighbours
...
def test_one_step_diffusion_distance_is_metric_like_and_symmetric():
    ...
    from projects.active.terpene_screening.geometry.multiscale import one_step_diffusion_distance
...
def test_resolution_product_partition_conserves_each_atom_and_ignores_missing_view():
    from projects.active.terpene_screening.geometry.multiscale import resolution_product_partition
