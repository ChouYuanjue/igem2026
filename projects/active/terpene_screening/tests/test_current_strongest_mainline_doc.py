...
def test_current_strongest_is_success_mainline_not_failure_roadmap():
 ...
 assert '## Current routed-system contract' in text and 'query-conditional rather than a score fusion' in text
 assert 'CATALYST_FAST_R2E_SIMILARITY_ROUTER_V1_RESULT.json' in text and 'sim<0.9' in text
