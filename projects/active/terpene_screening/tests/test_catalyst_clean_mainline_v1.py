...
def test_final_mainline_manifest_is_direction_safe_and_no_fake_fusion():
 ...
 assert p['production_default']['expert']=='r2e_center_bounded_cap0p1_full_clean2023'
...
def test_capability_evolution_ends_in_confirmed_production_package():
 ...
 assert p['status']=='canonical_success_mainline' and [x['stage'] for x in p['evolution']]==[1,2,3,4,5,6]
 assert '218,537' in p['evolution'][-1]['headline']
