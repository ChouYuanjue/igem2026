...
def test_final_mainline_manifest_is_direction_safe_and_no_fake_fusion():
 ...
 assert p['production_default']['expert']=='r2e_lambdarank_fusion_v1'
 assert p['router']['uses_target_test_labels'] is False and p['router']['score_fusion_performed'] is True
