import numpy as np
import pytest
from projects.active.terpene_screening.product_correspondence_field import (
...
def test_correspondence_witness_exactly_decomposes_field():
    from projects.active.terpene_screening.product_correspondence_field import correspondence_witness
