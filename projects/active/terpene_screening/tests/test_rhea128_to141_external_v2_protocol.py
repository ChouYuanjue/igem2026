...
def test_release_rebuilder_uses_tracked_clean_boundary_as_alignment_witness():
    from projects.active.terpene_screening.rebuild_rhea128_to141_strict_support_v2 import compact_alignment_witness
...
def test_frozen_protocol_file_hash_remains_immutable():
    ...
    result=json.loads((ROOT/'projects/active/terpene_screening/CLEANROOM_R2E_RHEA128_TO141_EXTERNAL_V2_RESULT.json').read_text())
