# Sparse Correspondence Geometry — MARTS Mainline
...
The implementation in product_correspondence_field.py is exactly equal, element by element, to rebuilding the field from scratch after adding the seed.
