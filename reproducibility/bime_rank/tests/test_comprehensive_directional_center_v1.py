...
from projects.active.terpene_screening.runtime.cli import BoundedIdentityHiddenResidualReactionDualTower
from reproducibility.bime_rank.scripts.train_cleanroom_directional_identity_aux_residual import (
    _local_positive_rows,
    _sample_global_teacher_candidates,
    build_output_feature_schema,
    configure_identity_residual_trainables,
)
from projects.active.terpene_screening.runtime.base_model import ModelConfig

ROOT = Path(__file__).resolve().parents[3]
PROTOCOL = ROOT / "reproducibility/bime_rank/records/CATALYST_COMPREHENSIVE_DIRECTIONAL_CENTER_V1.json"
