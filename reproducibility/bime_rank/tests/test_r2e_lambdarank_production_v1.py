...
from projects.active.terpene_screening.runtime.enzyme_ranker import (
    build_features,
    full_order,
    lexical_rank,
    load_ranker,
)
from reproducibility.bime_rank.scripts.run_r2e_lambdarank_fusion_v1 import (
...
CANDIDATE=ROOT/'reproducibility/bime_rank/configs/terpene_lambdarank_candidate_v1.yaml'
DEFAULT=ROOT/'configs/production_routes/default.yaml'
LEGACY_V3=ROOT/'reproducibility/bime_rank/configs/terpene_similarity_router_v3.yaml'
...
def test_default_bime_manifest_retains_promoted_r2e_learned_fusion():
