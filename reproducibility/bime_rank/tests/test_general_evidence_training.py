...
from reproducibility.bime_rank.scripts.train_general_evidence_retriever import (
...
def test_recadam_optimizer_uses_frozen_source_parameters():
    from reproducibility.bime_rank.third_party.recadam import RecAdam
...
def test_build_optimizer_selects_recadam_and_matches_trainable_parameters():
    from reproducibility.bime_rank.third_party.recadam import RecAdam
    from projects.active.terpene_screening.runtime.base_model import ModelConfig, TerpeneDualTower
    from reproducibility.bime_rank.scripts.train_general_evidence_retriever import _build_optimizer
...
def test_mammoth_lwf_distillation_prefers_teacher_aligned_student():
    from reproducibility.bime_rank.third_party.mammoth_lwf import distillation
...
def test_mammoth_bidirectional_distillation_penalizes_column_reordering():
    from reproducibility.bime_rank.third_party.mammoth_lwf import bidirectional_distillation
