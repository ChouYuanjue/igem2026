...
import numpy as np
from reproducibility.bime_rank.support.evaluate_r2e_lambdarank_fusion_v1_confirmation import apply_prefix_rerank_positive_ranks
from reproducibility.bime_rank.scripts.run_r2e_lambdarank_fusion_v1 import Config
...
def test_frozen_confirmation_contract_is_new_salt_and_single_run():
 p=json.loads((ROOT/'reproducibility/bime_rank/records/CATALYST_R2E_LAMBDARANK_FUSION_V1.json').read_text())
...
def test_prefix_rerank_preserves_tail_relative_order(monkeypatch):
 import reproducibility.bime_rank.support.evaluate_r2e_lambdarank_fusion_v1_confirmation as mod
