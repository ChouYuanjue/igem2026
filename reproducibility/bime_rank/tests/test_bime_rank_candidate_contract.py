...
PROD = ROOT / "configs/production_routes/default.yaml"
CAND = ROOT / "reproducibility/bime_rank/configs/bime_rank_candidate_v1.yaml"
ADMISSION = ROOT / "reproducibility/bime_rank/records/BIME_RANK_EXPERT_ADMISSION_V1.json"
