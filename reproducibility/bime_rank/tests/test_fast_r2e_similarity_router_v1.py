...
from reproducibility.bime_rank.support.evaluate_fast_r2e_similarity_router_v1 import evaluate
ROOT=Path(__file__).resolve().parents[3]
def test_protocol_freezes_threshold_and_confirmation() -> None:
    p=json.loads((ROOT/'configs/retrieval/enzyme_search_routing.json').read_text())
