...
prod1=J('reproducibility/bime_rank/records/BIME_RANK_PRODUCTION_V1_RESULT.json')
prod2=J('reproducibility/bime_rank/records/BIME_RANK_PRODUCTION_V2_RESULT.json')
...
payload={
 ...
 'policy':{
  ...
  'candidate_manifest':'reproducibility/bime_rank/configs/bime_rank_candidate_v1.yaml','default_production_manifest':'configs/production_routes/default.yaml'},
 'experts':{},
 'candidate_runtime':{
...
payload['experts']['r2e_clipzyme_structure']={
 ...
 'runtime':'projects/active/terpene_screening/runtime/reaction_to_enzyme.py','fallback':'exact frozen R2E LambdaRank when reaction lacks CLIPZyme support',
...
payload['experts']['e2r_clipzyme_structure']={
 ...
 'runtime':'projects/active/terpene_screening/runtime/enzyme_to_reaction.py',
...
payload['current_production_result']='reproducibility/bime_rank/records/BIME_RANK_PRODUCTION_V2_RESULT.json'


DEFAULT_OUTPUT = ROOT / "reproducibility/bime_rank/records/BIME_RANK_EXPERT_ADMISSION_V1.json"
