...
from reproducibility.bime_rank.scripts.prepare_rhea_snapshot_delta_external_benchmark_v2 import (
    CELL,
    DEFAULT_CLEAN,
...
def rebuild(
    ...
    *,
    ...
    result = {
        ...
        "frozen_builder": "reproducibility/bime_rank/scripts/prepare_rhea_snapshot_delta_external_benchmark_v2.py",
        "frozen_protocol": "reproducibility/bime_rank/records/CLEANROOM_R2E_RHEA128_TO141_EXTERNAL_V2.json",
