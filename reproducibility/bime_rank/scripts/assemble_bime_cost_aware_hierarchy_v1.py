...
DEFAULT_OUTPUT = ROOT / "reproducibility/bime_rank/records/BIME_RANK_COST_AWARE_HIERARCHY_V1_RESULT.json"
...
def assembled_payload() -> dict:
    ...
    admission = J("reproducibility/bime_rank/records/BIME_RANK_EXPERT_ADMISSION_V1.json")
    ...
    return {
      ...
      "implementation": {
        "planner": "projects/active/terpene_screening/runtime/backend_routing.py",
        "r2e_runtime": "projects/active/terpene_screening/runtime/reaction_to_enzyme.py",
        "e2r_runtime": "projects/active/terpene_screening/runtime/enzyme_to_reaction.py",
        "retention_evaluator": "reproducibility/bime_rank/scripts/evaluate_bime_cost_aware_shortlist_retention_v1.py",
        "contract_test": "reproducibility/bime_rank/tests/test_hierarchical_expert_routing.py"
      }
    }
