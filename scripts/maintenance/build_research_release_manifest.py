...
MODEL_REPRODUCTION_SUPPORT_ROOTS = [
    "results/catalyst_clean_mainline_v1/r2e_base_rdkitplus",
    "results/catalyst_clean_mainline_v1/r2e_enzgfm_base_router_v1",
...
PRODUCTION_ROUTE_EVIDENCE_FILES = [
    "configs/retrieval/enzyme_search_routing.json",
    "configs/retrieval/enzyme_ranking_validation.json",
    "configs/retrieval/reaction_model_validation.json",
...
REBUILDABLE_ASSETS = [
    {
        ...
        "builder": "reproducibility/bime_rank/scripts/combine_protein_feature_blocks.py",
        "command": ".venv/bin/python reproducibility/bime_rank/scripts/combine_protein_feature_blocks.py --base-dir data/catalyst_candidate_universes/general_merged/proteins --aux-dir data/external/enzgfm_current/general_merged_650m_mean_v1 --output-dir data/external/enzgfm_current/general_merged_esmc_enzgfm_equalblock_v1",
        "inputs": [
            "data/catalyst_candidate_universes/general_merged/proteins/entries.csv",
    ...
    },
    {
        ...
        "builder": "reproducibility/bime_rank/scripts/rebuild_horizyn_distillation_preprocessing.py",
        "command": ".venv/bin/python reproducibility/bime_rank/scripts/rebuild_horizyn_distillation_preprocessing.py",
    ...
    },
    {
        ...
        "builder": "reproducibility/bime_rank/scripts/rebuild_reactzyme_transfer_assets.py",
        "command": ".venv/bin/python reproducibility/bime_rank/scripts/rebuild_reactzyme_transfer_assets.py",
    ...
    },
    {
        ...
        "builder": "reproducibility/bime_rank/scripts/build_enzgfm_protein_features.py",
        "merge_builder": "reproducibility/bime_rank/scripts/merge_protein_feature_libraries.py",
        "command": ".venv/bin/python reproducibility/bime_rank/scripts/build_enzgfm_protein_features.py --sequences data/catalyst_candidate_universes/general_merged/protein_sequences.tsv --all-proteins --model-dir external_models/enzgfm/EnzGFM_650M --reference-root external/enzgfm_reference --output-dir data/external/enzgfm_current/general_merged_650m_mean_v1",
    ...
    },
    {
        ...
        "builder": "reproducibility/bime_rank/scripts/build_general_reaction_features.py",
        "command": ".venv/bin/python reproducibility/bime_rank/scripts/build_general_reaction_features.py",
    },
    {
        ...
        "kind": "derived_feature_matrix",
        "builder": "reproducibility/bime_rank/scripts/build_rdkitplus_augmented_reaction_features.py",
        "command": ".venv/bin/python reproducibility/bime_rank/scripts/build_rdkitplus_augmented_reaction_features.py",
...
EVALUATION_SUPPORT_REBUILDS = [
    {
        ...
        "builder": "reproducibility/bime_rank/scripts/rebuild_rhea128_to141_strict_support_v2.py",
        "command": ".venv/bin/python reproducibility/bime_rank/scripts/rebuild_rhea128_to141_strict_support_v2.py --release128-sprot data/external/rhea_snapshot_external_v1/release128_rhea2uniprot_sprot.tsv --release141-sprot data/external/rhea_snapshot_external_v1/release141_rhea2uniprot_sprot.tsv --output-root <output-dir>",
...
def main() -> None:
    ...
    payload = {
        ...
        "validation": {
            ...
            "source_role_builder": "scripts/maintenance/build_source_roles.py",
            ...
            "project_test_runner": "scripts/maintenance/run_reproduction_tests.py",
            "release_regression_suite": [
                "scripts/maintenance/tests/test_bime_asset_resolver.py",
                "reproducibility/bime_rank/tests/test_bime_context_experts.py",
