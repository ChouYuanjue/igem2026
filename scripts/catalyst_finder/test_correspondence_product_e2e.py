...
def r2e_plan(**_kwargs):
    return {
        ...
        'candidate_universe_source':'deepseek_semantic_scope','planned_route_id':'marts-correspondence-r2e-v1',
        'warnings':[],
    }
...
def e2r_plan(**_kwargs):
    return {
        ...
        'candidate_universe':MARTS_CORRESPONDENCE_UNIVERSE,
        'candidate_universe_source':'deepseek_semantic_scope','planned_route_id':'marts-correspondence-e2r-v1',
        'warnings':[],
    }
...
def test_reference_protein_reuses_cached_multiresolution_state_without_encoder(runtime,monkeypatch):
    ...
    import scripts.catalyst_finder.correspondence_geometry_service as module
