...
from projects.active.terpene_screening.runtime.reaction_similarity import (
    best_match_similarity,
    reaction_features,
)
from projects.active.terpene_screening.runtime.reaction_encoding import canonical_or_raw_reaction
from projects.active.terpene_screening.geometry.extension import (
    attach_query_to_reference,
    query_geodesic_to_reference,
)
from projects.active.terpene_screening.runtime.entities import reaction_signature
from projects.active.terpene_screening.runtime.cli import encode_external_enzymes_with_audit
from projects.active.terpene_screening.geometry.structure import query_structural_view
...
STRUCTURAL_WORK_ROOT = ROOT / 'results/catalyst_finder_runtime/tmp'


class CorrespondenceGeometryService:
    """Read-only online realization of the canonical MARTS correspondence field.
        ...
        candidates = [
            {
                ...
                'selection_source': 'marts_correspondence_geometry',
                'evidence_passport': {},
            }
    ...
    def _query_metadata(
        ...
        return {
            ...
            'route_id': f'marts-correspondence-{"r2e" if direction == "reaction_to_enzyme" else "e2r"}-v1' + ('+fewshot' if has_seed else ''),
            ...
            'registry_version': 'marts-production-omega',
