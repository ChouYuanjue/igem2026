...
import scripts.catalyst_finder.retrieval.gateway as gateway_module
from projects.active.terpene_screening.core.candidate_universes import DEFAULT_CANDIDATE_UNIVERSE, MARTS_CORRESPONDENCE_UNIVERSE
...
def test_gateway_marts_scope_bypasses_legacy_engine(monkeypatch):
    ...
    assert result['query']['model_expert']=='marts_correspondence_geometry'
