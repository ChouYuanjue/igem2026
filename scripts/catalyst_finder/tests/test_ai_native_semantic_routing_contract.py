...
LANGUAGE=(ROOT/'scripts/catalyst_finder/routing/language.py').read_text()
TOOLS=(ROOT/'scripts/catalyst_finder/agent_harness/tool_registry.py').read_text()
FRONT_JS=(ROOT/'frontend/catalyst_finder/app.js').read_text()
FRONT_HTML=(ROOT/'frontend/catalyst_finder/index.html').read_text()
