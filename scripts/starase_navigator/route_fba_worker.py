...
SITE = ROOT / "results/starase_navigator_runtime/route_feasibility/fba_site"
MODEL_PATH = ROOT / "results/starase_navigator_runtime/route_feasibility/iML1515.json"
