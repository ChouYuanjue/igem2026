...
class Handler(BaseHTTPRequestHandler):
    ...
    def _error(self, exc: AppError) -> None:
        ...
        if exc.detail and os.environ.get("STARASE_NAVIGATOR_DEBUG") == "1":
    ...
    def log_message(self, fmt: str, *args: object) -> None:
        ...
        print(f"starase-navigator {self.address_string()} {message}", file=sys.stderr)
