...
from scripts.starase_navigator.route_design import RheaRouteDesigner
...
class RouteFeasibilityAnalyzer:
    ...
    def __init__(self, root: Path, route_designer: RheaRouteDesigner) -> None:
        ...
        self.runtime = self.root / "results/starase_navigator_runtime/route_feasibility"
        self.thermo_worker = self.root / "scripts/starase_navigator/route_thermo_worker.py"
        self.fba_worker = self.root / "scripts/starase_navigator/route_fba_worker.py"
