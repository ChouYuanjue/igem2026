...
from scripts.starase_navigator.route_catalog import build_route_catalog
...
R2E_MODULES: dict[str, dict[str, str]] = {
    ...
    "r2e-universe": {
        ...
        "subtitle": "AI 选择的搜索范围",
        "kind": "universe",
        "detail": "系统根据问题语义与已核对目标选择本次搜索范围；候选来源和规模写入运行时 provenance，但不要求用户理解内部数据切片。",
    },
    "r2e-taxonomy": {
        "title": "物种范围筛选",
        "subtitle": "全部 / 真核 / 原核",
    ...
    "r2e-router": {
        "title": "AI 检索规划",
        "subtitle": "范围 × 已知证据 × 分析深度",
        "kind": "router",
        "detail": "系统综合目标实体、已知阳性证据、用户实验意图与分析深度，自动选择实际执行路径。",
    },
    "r2e-active-expert": {
        "title": "执行候选排序",
        "subtitle": "selected ranking capability",
        "kind": "model",
        "detail": "使用本次 AI 选择的搜索范围和已核对证据产生主排序；具体运行资产仅记录在 provenance 中。",
    },
    "r2e-current-model": {
        "title": "TPS 当前反应检索专家",
...
E2R_MODULES: dict[str, dict[str, str]] = {
    ...
    "e2r-universe": {
        ...
        "subtitle": "AI 选择的搜索范围",
        "kind": "universe",
        "detail": "系统根据问题语义与已核对蛋白上下文自动确定本次反应搜索范围，并从运行时 metadata 读取实际覆盖规模。",
    },
    "e2r-router": {
        "title": "AI 检索规划",
        "subtitle": "范围 × 已知证据 × 分析深度",
        "kind": "router",
        "detail": "系统根据用户目标、已核对蛋白上下文与所需证据深度自动选择实际执行路径。",
    },
    "e2r-active-expert": {
        "title": "执行候选排序",
        "subtitle": "selected ranking capability",
...
DOWNSTREAM_WORKFLOWS = [
    {
        ...
        "availability": "starase_navigator",
