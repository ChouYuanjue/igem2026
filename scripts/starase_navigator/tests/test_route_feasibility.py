...
from scripts.starase_navigator.route_feasibility import RouteFeasibilityAnalyzer
...
class RouteFeasibilityTests(unittest.TestCase):
    ...
    def test_real_ecoli_pool_is_preferred_when_present(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            pool = root / "results/starase_navigator_runtime/route_feasibility/iML1515_cytosol_chebi.txt"
