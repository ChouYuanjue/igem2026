import pandas as pd
from scripts.starase_navigator.observations.inventory import ObservationInventory, PROTEIN_COVERAGE, REACTION_COVERAGE
...
def test_local_structure_lookup_reuses_existing_cache_without_network():
    ...
    from scripts.starase_navigator.evidence_catalog import IntegratedEvidenceCatalog
