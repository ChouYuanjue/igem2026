...
from scripts.starase_navigator.homology import CURRENT_SEQUENCES, PRODUCTION_REGISTRY, ProteinHomologyIndex
from scripts.starase_navigator.route_view import build_e2r_route_view, build_r2e_route_view, system_route_catalog
