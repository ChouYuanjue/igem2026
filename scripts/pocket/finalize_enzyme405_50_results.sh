...
"${PYTHON}" projects/active/pocket_robustness/analysis/build_best_available_result_matrix.py \
...
"${PYTHON}" projects/active/pocket_robustness/analysis/compare_all_baselines.py \
  --results_root results/pocket \
  --baseline_matrix projects/active/pocket_robustness/configs/baseline_matrix.yaml \
...
"${PYTHON}" projects/active/pocket_robustness/analysis/render_enzyme405_50_chinese_report.py \
  --results_root results/pocket \
  --matrix_csv results/pocket/enzyme405_50_result_matrix.csv \
