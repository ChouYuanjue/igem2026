...
"""Clean-dev v2 evaluator with a multiscale chemical product metric on the reaction axis.
...
from projects.active.terpene_screening.geometry.multiscale import (
    ...
    self_tuning_product_neighbours,
)

OUT = ROOT / "results/geometric_product_flow_clean_dev_v2"
...
def evaluate_fold(
    ...
    for qi, q in enumerate(query_ids):
        ...
        selected_train, reaction_chart_info = self_tuning_product_neighbours(
        ...
        reaction_affinity, reaction_kernel_info = self_tuning_product_affinity(
        ...
        diagnostics.append(
            {
                ...
                "reaction_graph_undirected_edges": int(reaction_kernel_info.undirected_edges),
    ...
    summary = {
        "method": "multiscale_reaction_product_geometry_charbonnier_bregman_field_v2",
        "fold": fold,
        ...
        "reaction_geometry": "geometric mean of self-tuning Gaussian kernels on DRFP global, RDKitPlus whole-reaction, and atom-mapped reaction-center Jaccard coordinates; missing coordinate views are neutral",
        "reaction_view_dimensions": {"drfp_global": drfp_dim, "rdkitplus_whole": rdkit_dim, "mapped_center": center_dim},
        "reaction_view_policy": "no learned/interpolated view weights; categorical one-hot block excluded to avoid hard partitions",
