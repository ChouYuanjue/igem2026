...
.venv/bin/python archive/terpene_screening/lineage/evaluate_open_world_uncertainty.py \
  --output-dir results/terpene_open_world_uncertainty_dual_kernel_candidate_v1 \
  --device cuda
.venv/bin/python reproducibility/bime_rank/support/rank_registry_batch.py \
