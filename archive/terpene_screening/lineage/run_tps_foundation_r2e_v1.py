...
from projects.active.terpene_screening.runtime.ranking_metrics import evaluate_full_candidate_ranks, summarize_query_metrics
...
PROTOCOL=ROOT/'archive/terpene_screening/records/CATALYST_TPS_FOUNDATION_R2E_V1.json'
...
TRAINER=ROOT/'reproducibility/bime_rank/scripts/train_cleanroom_rhea_retriever.py'
