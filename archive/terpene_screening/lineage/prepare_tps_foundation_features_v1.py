...
from reproducibility.bime_rank.scripts.build_enzgfm_protein_features import load_runtime, truncate_middle
...
def main():
 ...
 subprocess.run([str(ROOT/'.venv/bin/python'),str(ROOT/'reproducibility/bime_rank/scripts/build_rdkitplus_augmented_reaction_features.py'),'--reactions',str(reactions),'--base-feature-dir',str(base),'--base-schema-dir',str(base),'--output-dir',str(rd)],cwd=ROOT,check=True)
