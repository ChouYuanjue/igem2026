...
OUT=ROOT/'results/terpene_multiresolution_product_heat_dev_v2'
BUDGETS=(3,10,20)
...
def main() -> None:
    ...
    summary={
      'version':'terpene-multiresolution-product-heat-dev-v2','partition':'development_only','development_rule':'protein_fold==4 or reaction_fold==4',
      ...
      'parameter_selection':'none; symmetric normalized-Laplacian heat and symmetric degree normalization of the empirical positive measure remove geometric/annotation density without tuned coefficients; no grid search, learned score fusion, negatives, or frozen partition labels',
