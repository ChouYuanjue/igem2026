...
"""Clean-dev evaluator with diffusion-conformal conductance on the protein manifold.
...
from projects.active.terpene_screening.geometry.multiscale import diffusion_conformal_affinity

OUT = ROOT / "results/geometric_product_flow_protein_conformal_v1"
...
def evaluate_fold(
    ...
    summary = {
        "method": "protein_diffusion_conformal_charbonnier_bregman_field_v1",
        "fold": fold,
        ...
        "protein_geometry": "original self-tuning ESM-C/observed-CLIP atlas topology with conductance multiplied by an exact t=1 diffusion heat kernel on the same edges; no new edges and no learned scale",
        "flow_strength": 1.0,
