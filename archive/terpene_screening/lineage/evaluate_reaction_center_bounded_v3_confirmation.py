...
from archive.terpene_screening.lineage.evaluate_reaction_center_bounded_v3_selection import paired_summary
PROTOCOL=ROOT/'archive/terpene_screening/records/CLEANROOM_R2E_REACTION_CENTER_BOUNDED_RESIDUAL_V3_CONFIRMATION_V1.json'
