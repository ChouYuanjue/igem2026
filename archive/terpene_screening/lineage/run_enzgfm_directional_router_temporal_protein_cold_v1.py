...
from archive.terpene_screening.lineage.run_enzgfm_nested_outer_v2 import (
    complete_fold,
    final_complete,
    train_command,
)
...
SELECT = ROOT / "archive/terpene_screening/lineage/select_cleanroom_directional_multifold.py"
EVAL = ROOT / "reproducibility/bime_rank/scripts/evaluate_broad_rhea_benchmark.py"
FREEZE = ROOT / "archive/terpene_screening/records/CLEANROOM_ENZGFM_DIRECTIONAL_ROUTER_TEMPORAL_PROTEIN_COLD_V1.json"
