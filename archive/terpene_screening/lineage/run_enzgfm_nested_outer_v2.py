...
SELECT = ROOT / "archive/terpene_screening/lineage/select_cleanroom_bidirectional_multifold.py"
EVAL = ROOT / "reproducibility/bime_rank/scripts/evaluate_broad_rhea_benchmark.py"
FREEZE = ROOT / "archive/terpene_screening/records/CLEANROOM_ENZGFM_NESTED_OUTER_V2.json"
