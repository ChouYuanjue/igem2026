...
PROTOCOL=ROOT/'reproducibility/bime_rank/records/CLEANROOM_R2E_RHEA128_TO141_EXTERNAL_V2.json'
BUILDER=ROOT/'reproducibility/bime_rank/scripts/prepare_rhea_snapshot_delta_external_benchmark_v2.py'
BROAD=ROOT/'reproducibility/bime_rank/scripts/evaluate_broad_rhea_benchmark.py'
FINAL=ROOT/'archive/terpene_screening/lineage/evaluate_rhea128_to141_external_v2.py'
