...
from projects.active.terpene_screening.runtime.entities import normalize_marts_reactions
from archive.terpene_screening.lineage.build_sequence_clusters import resolve_mmseqs

ROOT = Path(__file__).resolve().parents[3]
PROTOCOL = ROOT / 'archive/terpene_screening/records/CATALYST_TPS_TEMPORAL_R2E_V1.json'
