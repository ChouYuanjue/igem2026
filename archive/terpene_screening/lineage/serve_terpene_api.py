...
from archive.terpene_screening.lineage.manage_open_world_registry import (  # noqa: E402
...
class Handler(BaseHTTPRequestHandler):
    ...
    def _registry_write(self, command: str, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        argv = [
            sys.executable,
            str(ROOT / "archive/terpene_screening/lineage/manage_open_world_registry.py"),
            command,
        ]
