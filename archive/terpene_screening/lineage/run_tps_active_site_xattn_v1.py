...
from archive.terpene_screening.lineage.tps_active_site_xattn_model import TPSActiveSiteXAttn,XAttnConfig
PROTOCOL=ROOT/'archive/terpene_screening/records/CATALYST_TPS_ACTIVE_SITE_XATTN_V1.json'
