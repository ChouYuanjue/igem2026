...
"""Clean-dev evaluator for one anchored nonlinear field on reaction x protein geometry.
...
OUT = ROOT / "results/geometric_product_flow_clean_dev_v1"
...
def evaluate_fold(
    ...
    summary = {
        "method": "positive_measure_charbonnier_bregman_product_field_v1",
        "fold": fold,
        ...
        "protein_geometry": "ESM-C cosine refined by observed CLIPZyme structure geometry with availability-neutral equal weighting",
        "flow_strength": 1.0,
