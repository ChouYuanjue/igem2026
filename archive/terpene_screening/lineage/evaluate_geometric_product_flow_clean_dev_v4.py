...
"""Clean-dev v4 evaluator with a perplexity-contraction reaction metric tensor.
...
OUT = ROOT / "results/geometric_product_flow_clean_dev_v4"
...
def evaluate_fold(
    ...
    summary = {
        "method": "perplexity_contraction_reaction_tensor_charbonnier_bregman_field_v4",
        "fold": fold,
